...
import { groupStyleColorStyles } from "../group-format-toolbar/group-style-color.styles.js";

export class BlockStyleColor extends PopoverControl {
  static properties = {
...
class ImageBackgroundColor extends BlockStyleColor {
