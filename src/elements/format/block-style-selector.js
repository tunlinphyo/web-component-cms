...
import { groupStyleSelectorStyles } from "../group-format/group-style-selector.styles.js";

class BlockStyleSelector extends LitElement {
  static properties = {
...
class ImageBorderWidth extends BlockStyleSelector {
  label = "Width";
...
class ImageBorderStyle extends BlockStyleSelector {
  label = "Type";
